      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-xl p-3 sm:p-5">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <div>
            ...
            <p className="text-base sm:text-lg font-display font-bold text-blue-600 dark:text-blue-300">{formatCurrency(totalRealizado)}</p>
          </div>
          <div>
          ...
          <motion.div key={tipo} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: gi * 0.08 }} className="glass-card rounded-xl overflow-hidden">
            ...
            >
              ...
              <div className="text-right shrink-0">
                <p className="text-xs sm:text-sm font-display font-bold text-blue-600 dark:text-blue-300">{formatCurrency(realized)}</p>
