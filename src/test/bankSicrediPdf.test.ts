...
it('Sicredi Dourados 25/09: lançamentos, cheque bloqueado e saldos', () => {
  ...
  console.log(JSON.stringify({ fut: r.transactions.filter(t=>t.futuro), n: r.transactions.length, sf: r.saldoFinalInformado, st: r.saldoComAplicacaoInformado, last, avisos: r.avisos }));
});
