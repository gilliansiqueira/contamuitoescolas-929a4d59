...
- Fluxo Diário: operações projetadas somam no Saldo Final Previsto, operações
  realizadas somam no Saldo Final Realizado (operacoesPrev / operacoesReal
  separados em DailyFlowTable).
